...
namespace wordle {
	...
	private:
		...
		void disableBoxes() {
			...
			if (WordGuessed) {  // reset the labels
				for (int j = 0; j < 25; j++) {
	...
	public:
		...
		cli::array<TextBox^>^ textBox;
		cli::array<Label^>^ label;
		cli::array<Label^>^ letters;
		...
		int CheckWord;
		int NumberOfTrys;
		int IndexBeforeBackSpace;

		bool NewGame;
		bool WordGuessed;
		bool WordNotInDictionary;
		bool BackSpaceUsed;
		bool dragging;
		bool GetIndex;
	...
	private: System::Windows::Forms::Label^ label51;
		   ...
		   {
			   InitializeComponent();
			   textBox = gcnew cli::array<TextBox^>(25);
			   label = gcnew cli::array<Label^>(25);
			   letters = gcnew cli::array<Label^>(26);
			   ...
			   //labels for letters
			   letters[25] = this->label26;
			   letters[26] = this->label27;
			   letters[27] = this->label28;
			   letters[28] = this->label29;
			   letters[29] = this->label30;
			   letters[30] = this->label31;
			   letters[31] = this->label32;
			   letters[32] = this->label33;
			   letters[33] = this->label34;
			   letters[34] = this->label35;
			   letters[35] = this->label36;
			   letters[36] = this->label37;
			   letters[37] = this->label38;
			   letters[38] = this->label39;
			   letters[39] = this->label40;
			   letters[40] = this->label41;
			   letters[41] = this->label42;
			   letters[42] = this->label43;
			   letters[43] = this->label44;
			   letters[44] = this->label45;
			   letters[45] = this->label46;
			   letters[46] = this->label47;
			   letters[47] = this->label48;
			   letters[48] = this->label49;
			   letters[49] = this->label50;
			   letters[50] = this->label51;
...
#pragma endregion
	...
	start:
		...
		//if the word is not in dictonary for testing
		if (WordNotInDictionary == true) {
			ClassPublic* info = new ClassPublic();
			ClassConvert* convert = new ClassConvert();
